...
public class Main {
    ...
    public static void main(String[] args)  throws Exception {
        ...
        //probar un trytest por lo menos ingresando un string
        //Try.Trytest();
        //Try.Trytest();
        //Try.Trytest();
            //Los throws sirven para que podamos notificar errores de una manera más personalizada y precisa para nuestro trabajo
            //ya que podemos elegir nosotros el mensaje del error para especificar donde se encuentra el error y ser más precisos en encontrarlos y arreglarlos
        //Throw.test("testing");
        //Throw.test2("testing");
        //Throw.test3(3,0);
        Throw.test4();
